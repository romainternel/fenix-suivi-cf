...
- **Cache-busting** : chaque déploiement incrémente `?v=N` sur les **8** balises `<link>`/`<script>` du projet (css/style.css + les 7 fichiers `js/*.js`) — jamais sur les CDN externes. Version actuelle : **v255**.
...
**Fonctionnel et en production (v255) :**
